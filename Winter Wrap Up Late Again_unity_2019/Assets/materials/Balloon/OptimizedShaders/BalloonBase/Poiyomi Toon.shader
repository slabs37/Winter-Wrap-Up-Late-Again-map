Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/486b33ef35e4b0d4ab47710fb44928cb"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void MochieBRDF(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, inout PoiMods poiMods)
			{
				...
				reflections = surfaceReduction * reflCol * FresnelLerp(specCol, specCol + lerp(specCol, 1, (0.2 /*_RefSpecFresnelStrength*/)) * (0.2 /*_RefSpecFresnelStrength*/), pbrNDotV);
