Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/2034f57fbe7a4ad4abb88b9bf315d88a"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyGlitter(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				{
					float2 st = (poiMesh.uv[(0.0 /*_GlitterUV*/)] + float4(0,0,0,0).xy * _Time.x) * (500.0 /*_GlitterFrequency*/);
					...
					switch((0.0 /*_GlitterMode*/))
					{
						...
						finalGlitter = lerp(0, (0.026 /*_GlitterMinBrightness*/) * glitterAlpha, glitterAlpha) + max(pow(saturate(dot(lerp(glitterReflectionDirection, poiCam.viewDir, (0.8 /*_GlitterBias*/)), poiCam.viewDir)), (300.0 /*_GlitterContrast*/)), 0);
						...
						finalGlitter = max((0.026 /*_GlitterMinBrightness*/) * glitterAlpha, brightness * glitterAlpha * smoothstep(0, 1, 1 - m_dist * (0.08 /*_GlitterCenterSize*/) * 10));
						break;
						case 2:
						if ((10.0 /*_GlitterSpeed*/) + glitterSpeedOffset > 0)
						{
						...
						finalGlitter = lerp(0, (0.026 /*_GlitterMinBrightness*/) * glitterAlpha, glitterAlpha) + max(pow(specAngle, (300.0 /*_GlitterContrast*/)), 0);
			...
			{
				float smoothness = (0.188 /*_MochieRoughnessMultiplier*/);
				float smoothness2 = (1.0 /*_MochieRoughnessMultiplier2*/);
				float metallic = (0.048 /*_MochieMetallicMultiplier*/);
