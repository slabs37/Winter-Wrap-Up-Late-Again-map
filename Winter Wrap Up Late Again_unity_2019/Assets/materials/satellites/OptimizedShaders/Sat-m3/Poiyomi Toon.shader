Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/7a354a45b882f404f860a822f35a7fcd"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void MetallicAndSpecularFragDataInit(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				float metallic = (0.8 /*_MochieMetallicMultiplier*/);
			...
			void MochieBRDF(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, inout PoiMods poiMods)
			{
				...
				reflections = surfaceReduction * reflCol * FresnelLerp(specCol, specCol + lerp(specCol, 1, (0.0 /*_RefSpecFresnelStrength*/)) * (0.0 /*_RefSpecFresnelStrength*/), pbrNDotV);
