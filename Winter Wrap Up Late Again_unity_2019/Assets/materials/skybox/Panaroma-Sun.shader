...
Shader "Skybox/Panoramic With Sun" {
Properties {
...
SubShader {
    ...
    Pass {
...
#ifdef _MAPPING_6_FRAMES_LAYOUT
            float3 layout : TEXCOORD2;
            float4 edgeSize : TEXCOORD3;
            float4 faceXCoordLayouts : TEXCOORD4;
            float4 faceYCoordLayouts : TEXCOORD5;
            float4 faceZCoordLayouts : TEXCOORD6;
#else
            float2 image180ScaleAndCutoff : TEXCOORD2;
        ...
        fixed4 frag (v2f i) : SV_Target
        {
            ...
            return half4(c + _LightColor0 * spec, 0);
        }
        ENDCG
    }
}
